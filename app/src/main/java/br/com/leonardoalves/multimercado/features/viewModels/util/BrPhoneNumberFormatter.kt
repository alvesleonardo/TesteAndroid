package br.com.leonardoalves.multimercado.features.viewModels.util
...
class BrPhoneNumberFormatter(private val mWeakEditText: WeakReference<EditText>) : TextWatcher {
